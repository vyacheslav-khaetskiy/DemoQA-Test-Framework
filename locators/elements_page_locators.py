...
class WebTablePageLocators:
    ...
    ROW_COUNT_LIST = (By.CSS_SELECTOR, 'select[aria-label="rows per page"]')
...
class ButtonsPageLocators:
    ...
    CLICK_ME_BUTTON = (By.CSS_SELECTOR, 'button[class="btn btn-primary"]'
                                        ':not([id="doubleClickBtn"])'
                                        ':not([id="rightClickBtn"])')
...
class DynamicPropertiesPageLocators:
    ENABLE_AFTER_5_SECONDS_BUTTON = (By.CSS_SELECTOR, 'button[id="enableAfter"]')
